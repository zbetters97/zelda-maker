...
public class EntityGenerator {
    ...
    public EntityGenerator(GamePanel gp) {
        ...
        npcFactory.put(NPC_Kid.npcName, () -> new NPC_Kid(gp, 0, 0));
        npcFactory.put(NPC_Girl.npcName, () -> new NPC_Girl(gp, 0, 0));
        ...
        collectableFactory.put(COL_Rupee_Purple.colName, () -> new COL_Rupee_Purple(gp));
        collectableFactory.put(COL_Rupee_Silver.colName, () -> new COL_Rupee_Silver(gp));
        collectableFactory.put(COL_Rupee_Gold.colName, () -> new COL_Rupee_Gold(gp));
